...
//values for the access form values
//actions are the using for set the errors
...
const createAppointment = (values, actions) => {
    axios.post('/api/appointments/create', form)
        .then((response) => {
            router.push('/admin/appointments'); // update create to redirect
...
const editMode = ref(false) //by default false using reactive reference.
...
const getAppointment = () => {
    axios.get(`/api/appointments/${route.params.id}/edit`)
        ...
        .then(({ data }) => {
            ...
            form.start_time = data.formatted_start_time; //using accessor in Appointment model we are changing format
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><span v-if="editMode">Edit</span> <span v-else>Create</span></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <!-- <form @submit.prevent="handleSubmit()"> only when we are not using ve-validate, 
                                                                                                                                                                                                                                                                                                                                                                                                                                                        when using ve-validate automatically it wil prevent and no need to give as () -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.end_time" type="text" class="form-control flatpickr"
